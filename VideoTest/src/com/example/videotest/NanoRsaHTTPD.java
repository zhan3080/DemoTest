 ...
 */
public abstract class NanoRsaHTTPD {
    /*
...
//    private playbackService mPlaybackService;
    ...
    public NanoRsaHTTPD(Context c, int port) {
        this(c, null, port);
    }

    public NanoRsaHTTPD(Context c, String hostname, int port) {
    	mContext = c;
...
//		ed1.commit();
    	Log.i("", "ServerSocket creat"+myServerSocket.getLocalPort());
